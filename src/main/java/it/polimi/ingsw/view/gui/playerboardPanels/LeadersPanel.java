...
public class LeadersPanel extends JPanel {
    public LeadersPanel(LeaderCard lc1, LeaderCard lc2, boolean own) {
        ...
        ImageIcon covered = new ImageIcon(new ImageIcon("src/main/resources/ResourceIcons/back.PNG").getImage().getScaledInstance(x,y,Image.SCALE_DEFAULT));

        if(lc1 != null){
            ImageIcon i1 = new ImageIcon(new ImageIcon(lc1.getImage()).getImage().getScaledInstance(x,y, Image.SCALE_DEFAULT));
        ...
        if(lc2 != null){
            ImageIcon i2 = new ImageIcon(new ImageIcon(lc2.getImage()).getImage().getScaledInstance(x,y, Image.SCALE_DEFAULT));
