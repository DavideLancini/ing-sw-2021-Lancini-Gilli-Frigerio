...
public class TestViewHelper {
    ...
    public void TestS2SDevCard() {
        String first = new DevCard(Level.THREE, CardColor.GREEN, 12, new Resource[]{Resource.STONE, Resource.SHIELD},
                new Production(new Resource[]{Resource.STONE, Resource.STONE}, new Resource[]{Resource.SHIELD}, 1)).devCardView();
        String second = new DevCard(Level.ONE, CardColor.YELLOW, 3, new Resource[]{Resource.COIN, Resource.COIN, Resource.SERVANT},
                new Production(new Resource[]{Resource.SERVANT, Resource.STONE}, new Resource[]{Resource.COIN})).devCardView();
    ...
    public void TestS2SLeader() {
        String first = new LeaderDepot(1, Resource.SHIELD, Resource.COIN).view();
        String second = new LeaderSale(3, Resource.COIN, new CardColor[]{CardColor.PURPLE, CardColor.YELLOW}).view();
        String third = new LeaderTransform(3, Resource.SERVANT, new CardColor[]{CardColor.BLUE}).view();
        String fourth = new LeaderProduction(7, Resource.STONE, CardColor.GREEN, new Production(new Resource[]{}, new Resource[]{})).view();
